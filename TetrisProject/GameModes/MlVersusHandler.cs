...
public class MlVersusHandler : GameHandler
{
    ...
    public MlVersusHandler(ContentManager content, GameMode gameMode, Settings settings, List<Controls> controls, Main mainReference = null) : base(content, gameMode, settings, controls, mainReference)
    {
